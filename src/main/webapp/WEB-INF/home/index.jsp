...
<link rel="stylesheet" type="text/css"
	href="https://cdn.datatables.net/v/dt/jq-3.3.1/jszip-2.5.0/dt-1.10.21/b-1.6.2/b-flash-1.6.2/b-html5-1.6.2/b-print-1.6.2/datatables.min.css" />
<!-- datatables fin -->
<!DOCTYPE html>
<html lang="es">
<head>
		...
		<ul class="navbar-nav ml-auto ml-md-0">
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu dropdown-menu-right"
					...
					<a class="dropdown-item" href='<c:out value="/home" />'>Home</a> <a
						class="dropdown-item" href='<c:out value="/login" />'>Salir
						Sistema</a>
				</div></li>
		</ul>
	</nav>
					...
					<div class="nav">
						...
						<div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
									...
									<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pagesCollapseAutor" aria-expanded="false" aria-controls="pagesCollapseAutor">
                                        Residentes
                                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                    </a>
                                    <div class="collapse" id="pagesCollapseAutor" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
						...
						<a class="nav-link" href="https://www.facebook.com/"></pre>
							...
							</div> Facebook </a> <a class="nav-link"
				...
				<div class="container-fluid">
					...
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table mr-1"></i> DATOS DE LA COMUNIDAD
						</div>
						<div class="card-body">
