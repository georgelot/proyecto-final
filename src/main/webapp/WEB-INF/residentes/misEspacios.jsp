...
<title>Dashboard - Residentes</title>
		...
		<ul class="navbar-nav ml-auto ml-md-0">
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu dropdown-menu-right"
					...
					<a class="dropdown-item" href='<c:out value="/indexResidentes" />'>Home</a>
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid">
					<h1 class="mt-4">Gestion de mis Reservas</h1>

					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table mr-1"></i> Agendar mis Reservas a Espacios Comunes
						</div>
						<div class="card-body">
								...
								<form class="needs-validation" novalidate>
									<div class="form-row">
										<div class="form-group col-md-2">
										      <label for="inputDepartamento">Espacio</label>
										...
										<div class="col-md-3 mb-3">
											<label for="validationCustom02">Hora Inicio</label> <input
												type="time" class="form-control" id="validationCustom02"
												placeholder="horaInicio" value="" required>
											<div class="valid-feedback">Looks good!</div>
										</div>
										<div class="col-md-3 mb-3">
											<label for="validationCustom02">Hora Termino</label> <input
												type="time" class="form-control" id="validationCustom02"
												placeholder="horaFin" value="" required>
											<div class="valid-feedback">Looks good!</div>
										</div>		
									</div>
